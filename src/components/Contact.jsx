...
const Contact = () => {
    ...
    const githubOptions = [
        {
            name: "Business",
            href: "https://github.com/kirkhietpas-rldatix",
            external: true,
        },
        {
            name: "Pleasure",
    ...
    useEffect(() => {
        if (!isGithubOpen) return;

        const handlePointerDown = (event) => {
            if (!githubMenuRef.current?.contains(event.target)) {
                ...
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <div className="mt-12 pt-8 border-t border-gray-200">
                        ...
                        <div className="flex justify-center gap-6">
                            <div ref={githubMenuRef} className="relative">
                                <motion.button
                                    type="button"
                                    onClick={() => setIsGithubOpen((open) => !open)}
                                ...
                                <AnimatePresence>
                                    {isGithubOpen && (
                                        <motion.div
                                            ...
                                            className="absolute left-1/2 top-full z-20 mt-3 w-36 -translate-x-1/2 overflow-hidden rounded-xl border border-white/50 bg-white/95 shadow-lg backdrop-blur-sm"
                                        >
